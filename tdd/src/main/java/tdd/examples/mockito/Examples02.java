...
//        System.out.println(list.get(10));
        ...
        // stubbing
        when(mockedList.get(0)).thenReturn("first"); // mockedList.get(0) 호출하면 "first"를 리턴해라.
        when(mockedList.get(1)).thenThrow(new RuntimeException());  // mockedList.get(1) 호출하면 RuntimeException 예외 발생.
